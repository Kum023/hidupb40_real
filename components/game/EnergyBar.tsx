  ...
  return (
    <div className="relative flex items-center gap-2">
      ...
      {showTooltip && (
        ...
        >
          <p className="text-cyan-400 font-bold mb-1">{t("energyLabel")}</p>
          <div className="space-y-1 text-slate-300">
            <div className="flex justify-between">
              <span>{t("work5days")}</span>
            ...
            <div className="border-t border-slate-600 pt-1 flex justify-between font-bold">
              <span>{t("freeActionsLeft")}</span>
              <span className="text-emerald-400 font-mono">≈4</span>
            </div>
          </div>
          <p className="text-slate-500 mt-1.5">{t("salaryAutoNote")}</p>
          {/* Arrow */}
